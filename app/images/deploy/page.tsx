...
const templates: TemplateDef[] = [
  // --- Top 10 MCP Servers ---
  {
    key: "supabase-mcp-server",
    name: "Supabase MCP Server",
    image: "ghcr.io/metorial/mcp-container--supabase-community--supabase-mcp--mcp-server-supabase",
    description: "Supabase MCP Server: Open source Firebase alternative with real-time and restful APIs. (Command: node ./dist/transports/stdio.js --access-token $ACCESS_TOKEN)",
    ports: [],
    icon: "🟦",
    env: [
      { key: "ACCESS_TOKEN", description: "Supabase access token", required: true },
    ],
  },
  {
    key: "apimatic-validator-mcp",
    name: "APIMatic Validator MCP Server",
    image: "ghcr.io/metorial/mcp-container--apimatic--apimatic-validator-mcp--apimatic-validator-mcp",
    description: "Validate your APIs with APIMatic's powerful tools.",
    ports: [],
    icon: "🧪",
    env: [
      { key: "APIMATIC_API_KEY", description: "APIMatic API Key", required: true },
    ],
  },
  {
    key: "apify-mcp-server",
    name: "Apify MCP Server",
    image: "ghcr.io/metorial/mcp-container--apify--actors-mcp-server--actors-mcp-server",
    description: "Run Apify actors and automations via MCP.",
    ports: [],
    icon: "🤖",
    env: [
      { key: "APIFY_TOKEN", description: "Apify API Token", required: true },
    ],
  },
  {
    key: "searxng-mcp-server",
    name: "SearXNG MCP Server",
    image: "ghcr.io/metorial/mcp-container--ihor-sokoliuk--mcp-searxng--mcp-searxng",
    description: "Meta search engine MCP server for privacy-respecting web search.",
    ports: [],
    icon: "🌐",
    env: [
      { key: "SEARXNG_URL", description: "SearXNG instance URL", required: true },
    ],
  },
  {
    key: "chroma-mcp-server",
    name: "Chroma MCP Server",
    image: "ghcr.io/metorial/mcp-container--chroma-core--chroma-mcp--chroma-mcp",
    description: "Chroma: Open-source embedding database for AI applications. (Command: chroma-mcp --client-type ...)",
    ports: [],
    icon: "🟪",
    env: [
      { key: "CHROMA_CLIENT_TYPE", description: "Client type (e.g. rest, grpc)", required: true },
      { key: "CHROMA_DATA_DIR", description: "Data directory for Chroma", required: true },
      { key: "CHROMA_TENANT", description: "Tenant name", required: true },
      { key: "CHROMA_DATABASE", description: "Database name", required: true },
      { key: "CHROMA_API_KEY", description: "Chroma API key", required: true },
      { key: "CHROMA_HOST", description: "Chroma host", required: true },
      { key: "CHROMA_PORT", description: "Chroma port", required: true },
      { key: "CHROMA_CUSTOM_AUTH_CREDENTIALS", description: "Custom auth credentials", required: false },
      { key: "CHROMA_SSL", description: "Enable SSL (true/false)", required: false },
      { key: "CHROMA_DOTENV_PATH", description: "Path to .env file", required: false },
      { key: "CHROMA_COHERE_API_KEY", description: "Cohere API key (optional)", required: false },
    ],
  },
  {
    key: "zotero-mcp-server",
    name: "Zotero MCP Server",
    image: "ghcr.io/metorial/mcp-container--kaliaboi--mcp-zotero--mcp-zotero",
    description: "Zotero MCP: Reference management and research tool integration.",
    ports: [],
    icon: "📚",
    env: [
      { key: "ZOTERO_API_KEY", description: "Zotero API Key", required: true },
      { key: "ZOTERO_USER_ID", description: "Zotero User ID", required: true },
    ],
  },
  {
    key: "postman-mcp-server",
    name: "Postman MCP Server",
    image: "ghcr.io/metorial/mcp-container--delano--postman-mcp-server--postman-mcp-server",
    description: "Postman MCP: Automate API testing and monitoring.",
    ports: [],
    icon: "📬",
    env: [
      { key: "POSTMAN_API_KEY", description: "Postman API Key", required: true },
    ],
  },
  {
    key: "n8n-mcp-server",
    name: "n8n MCP Server",
    image: "ghcr.io/metorial/mcp-container--leonardsellem--n8n-mcp-server--n-8-n-mcp-server",
    description: "n8n MCP: Workflow automation for connecting apps and APIs.",
    ports: [],
    icon: "🔗",
    env: [
      { key: "N8N_API_URL", description: "n8n API URL", required: true },
      { key: "N8N_API_KEY", description: "n8n API Key", required: true },
      { key: "N8N_WEBHOOK_USERNAME", description: "Webhook username (optional)", required: false },
      { key: "N8N_WEBHOOK_PASSWORD", description: "Webhook password (optional)", required: false },
    ],
  },
  {
    key: "mongodb-mcp-server",
    name: "MongoDB MCP Server",
    image: "ghcr.io/metorial/mcp-container--kiliczsh--mcp-mongo-server--mcp-mongo-server",
    description: "MongoDB MCP: NoSQL database integration for your automations. (Command: node ./build/index.js MONGODB_URI)",
    ports: [],
    icon: "🍃",
    env: [
      { key: "MONGODB_URI", description: "MongoDB connection URI", required: true },
    ],
  },
  {
    key: "bitable-mcp-server",
    name: "Bitable MCP Server",
    image: "ghcr.io/metorial/mcp-container--lloydzhou--bitable-mcp--bitable-mcp",
    description: "Bitable MCP: Integrate with Bitable for collaborative tables.",
    ports: [],
    icon: "📊",
    env: [
      { key: "PERSONAL_BASE_TOKEN", description: "Personal base token", required: true },
      { key: "APP_TOKEN", description: "App token", required: true },
    ],
  },
  // Existing templates
  {
  ...
  {
    key: "devhub-cms-mcp-server",
    name: "DevHub CMS MCP Server",
    image: "ghcr.io/metorial/mcp-container--devhub--devhub-cms-mcp--devhub-cms-mcp",
    description: "DevHub CMS MCP: Integrate with DevHub CMS for content management.",
    ports: [],
    icon: "📰",
    env: [
      { key: "DEVHUB_API_KEY", description: "DevHub API Key", required: true },
      { key: "DEVHUB_API_SECRET", description: "DevHub API Secret", required: true },
      { key: "DEVHUB_BASE_URL", description: "DevHub Base URL", required: true },
    ],
  },
  {
    key: "wanaku-mcp-server",
    name: "Wanaku MCP Server",
    image: "ghcr.io/metorial/mcp-container--wanaku-ai--wanaku--wanaku",
    description: "Wanaku MCP: Router that connects everything. (Command: java  $JAVA_OPTS -jar target/*jar)",
    ports: [],
    icon: "🔗",
  },
  {
    key: "baidu-ai-search-mcp-server",
    name: "Baidu AI Search MCP Server",
    image: "ghcr.io/metorial/mcp-container--baidubce--app-builder--ai-search",
    description: "Baidu AI Search MCP: Search with Baidu AI.",
    ports: [],
    icon: "🔍",
  },
  {
    key: "difyworkflow-mcp-server",
    name: "Dify Workflow MCP Server",
    image: "ghcr.io/metorial/mcp-container--gotoolkits--mcp-difyworkflow-server--mcp-difyworkflow-server",
    description: "Dify Workflow MCP: Automate workflows with Dify.",
    ports: [],
    icon: "🔄",
    env: [
      { key: "DIFY_WORKFLOW_NAME", description: "Dify workflow name", required: true },
      { key: "DIFY_API_KEYS", description: "Dify API keys", required: true },
    ],
  },
  {
    key: "job-searchoor-mcp-server",
    name: "Job Searchoor MCP Server",
    image: "ghcr.io/metorial/mcp-container--0xdaef0f--job-searchoor--job-searchoor",
    description: "Job Searchoor MCP: Search for jobs programmatically.",
    ports: [],
    icon: "💼",
  },
  {
    key: "productboard-mcp-server",
    name: "Productboard MCP Server",
    image: "ghcr.io/metorial/mcp-container--kenjihikmatullah--productboard-mcp--productboard-mcp",
    description: "Productboard MCP: Product management integration.",
    ports: [],
    icon: "📋",
    env: [
      { key: "PRODUCTBOARD_ACCESS_TOKEN", description: "Productboard access token", required: true },
    ],
  },
  {
    key: "pubmed-mcp-server",
    name: "Simple PubMed MCP Server",
    image: "ghcr.io/metorial/mcp-container--andybrandt--mcp-simple-pubmed--mcp-simple-pubmed",
    description: "Simple PubMed MCP: Search and access PubMed data.",
    ports: [],
    icon: "🧬",
    env: [
      { key: "PUBMED_EMAIL", description: "PubMed email", required: true },
      { key: "PUBMED_API_KEY", description: "PubMed API key", required: true },
    ],
  },
  {
    key: "n8n-mcp-server-leonardsellem",
    name: "n8n MCP Server (LeonardSellem)",
    image: "ghcr.io/metorial/mcp-container--leonardsellem--n8n-mcp-server--n-8-n-mcp-server",
    description: "n8n MCP: Workflow automation for connecting apps and APIs (LeonardSellem version).",
    ports: [],
    icon: "🤖",
    env: [
      { key: "N8N_API_URL", description: "n8n API URL", required: true },
  ...
  {
    key: "verodat-mcp-server",
    name: "Verodat MCP Server",
    image: "ghcr.io/metorial/mcp-container--verodat--verodat-mcp-server--verodat-mcp-server",
    description: "Verodat MCP: AI-powered data platform integration.",
    ports: [],
    icon: "📊",
    env: [
      { key: "VERODAT_AI_API_KEY", description: "Verodat AI API key", required: true },
      { key: "VERODAT_API_BASE_URL", description: "Verodat API base URL", required: true },
    ],
  },
  {
    key: "mongodb-mcp-server-kiliczsh",
    name: "MongoDB MCP Server (kiliczsh)",
    image: "ghcr.io/metorial/mcp-container--kiliczsh--mcp-mongo-server--mcp-mongo-server",
    description: "MongoDB MCP: NoSQL database integration for your automations (kiliczsh version). (Command: node ./build/index.js MONGODB_URI)",
    ports: [],
    icon: "🍃",
    env: [
      { key: "MONGODB_URI", description: "MongoDB connection URI", required: true },
