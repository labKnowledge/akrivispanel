...
const templates: TemplateDef[] = [
  // --- Top 10 MCP Servers ---
  {
    ...
    description:
      "Supabase MCP Server: Open source Firebase alternative with real-time and restful APIs. (Command: node ./dist/transports/stdio.js --access-token $ACCESS_TOKEN)",
    ports: [],
    icon: "🟦",
    env: [
      {
  ...
  },
  {
    ...
    description:
      "Meta search engine MCP server for privacy-respecting web search.",
    ports: [],
    icon: "🌐",
    env: [
      {
  ...
  },
  {
    ...
    description:
      "Chroma: Open-source embedding database for AI applications. (Command: chroma-mcp --client-type ...)",
    ports: [],
    icon: "🟪",
    env: [
      {
        key: "CHROMA_CLIENT_TYPE",
        description: "Client type (e.g. rest, grpc)",
        required: true,
      },
      {
        key: "CHROMA_DATA_DIR",
        description: "Data directory for Chroma",
        required: true,
      },
      ...
      { key: "CHROMA_PORT", description: "Chroma port", required: true },
      {
        ...
        description: "Custom auth credentials",
        required: false,
      },
      {
        key: "CHROMA_SSL",
  ...
  },
  {
    ...
    description:
      "Zotero MCP: Reference management and research tool integration.",
    ports: [],
    icon: "📚",
    env: [
  ...
  },
  {
    ...
    env: [
      ...
      { key: "N8N_API_KEY", description: "n8n API Key", required: true },
      {
        ...
        description: "Webhook username (optional)",
        required: false,
      },
      {
        key: "N8N_WEBHOOK_PASSWORD",
        description: "Webhook password (optional)",
        required: false,
      },
    ],
  },
  {
    ...
    description:
      "MongoDB MCP: NoSQL database integration for your automations. (Command: node ./build/index.js MONGODB_URI)",
    ports: [],
    icon: "🍃",
    env: [
      {
  ...
  },
  {
    ...
    description:
      "Bitable MCP: Integrate with Bitable for collaborative tables.",
    ports: [],
    icon: "📊",
    env: [
      {
        key: "PERSONAL_BASE_TOKEN",
        description: "Personal base token",
        required: true,
      },
  ...
  },
  {
    ...
    description:
      "DevHub CMS MCP: Integrate with DevHub CMS for content management.",
    ports: [],
    icon: "📰",
    env: [
      { key: "DEVHUB_API_KEY", description: "DevHub API Key", required: true },
      {
        ...
        description: "DevHub API Secret",
        required: true,
      },
      {
        key: "DEVHUB_BASE_URL",
        description: "DevHub Base URL",
        required: true,
      },
    ],
  },
  {
    ...
    description:
      "Wanaku MCP: Router that connects everything. (Command: java  $JAVA_OPTS -jar target/*jar)",
    ports: [],
    icon: "🔗",
  },
  {
    ...
    env: [
      {
        ...
        description: "Productboard access token",
        required: true,
      },
    ],
  },
  ...
  },
  {
    ...
    image:
      "ghcr.io/metorial/mcp-container--leonardsellem--n8n-mcp-server--n-8-n-mcp-server",
    description:
      "n8n MCP: Workflow automation for connecting apps and APIs (LeonardSellem version).",
    ports: [],
    icon: "🤖",
    env: [
      { key: "N8N_API_URL", description: "n8n API URL", required: true },
    ...
    env: [
      {
        ...
        description: "Verodat AI API key",
        required: true,
      },
      {
        key: "VERODAT_API_BASE_URL",
        description: "Verodat API base URL",
        required: true,
      },
    ],
  },
  {
    ...
    image:
      "ghcr.io/metorial/mcp-container--kiliczsh--mcp-mongo-server--mcp-mongo-server",
    description:
      "MongoDB MCP: NoSQL database integration for your automations (kiliczsh version). (Command: node ./build/index.js MONGODB_URI)",
    ports: [],
    icon: "🍃",
    env: [
      {
